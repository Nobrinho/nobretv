<template>
  <div class="realtive h-full">
    ...
    <div v-else>
      ...
      <div class="relative flex text-white px-0 sm:py-0 gap-4">
        ...
        <div class="z-30 flex flex-wrap w-full justify-center md:mt-10">
          ...
          <div class="text-3xl px-2">
            <p>{{ mediaInfo.title }} - {{ getYear(mediaInfo.release_date) }}</p>
            <div class="flex flex-wrap gap-2">
              <p class="text-lg">Lançamento: {{ formatDateBR(mediaInfo.release_date) }}</p>
              <div class="text-lg bg-gray-700 rounded shadow text-white px-2">{{
                convertMinutesToHours(mediaInfo.runtime)
              }}</div>
